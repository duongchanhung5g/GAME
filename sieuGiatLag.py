...
current_music = None
menu_music = None
if sound_ok and os.path.exists("menu.mp3"):
    menu_music = "menu.mp3"
blaster_sound = None
if sound_ok and os.path.exists("blastersound.mp3"):
    blaster_sound = pygame.mixer.Sound("blastersound.mp3")
    blaster_sound.set_volume(0.3) 
# ===== LOAD =====
